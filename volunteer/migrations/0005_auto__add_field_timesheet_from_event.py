...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timesheet.from_event'
        db.add_column(u'volunteer_timesheet', 'from_event',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timesheet.from_event'
        db.delete_column(u'volunteer_timesheet', 'from_event')
