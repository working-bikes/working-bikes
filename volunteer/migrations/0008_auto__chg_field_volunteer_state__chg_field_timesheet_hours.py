...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Volunteer.state'
        db.alter_column(u'volunteer_volunteer', 'state', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Volunteer.state'
        db.alter_column(u'volunteer_volunteer', 'state', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Timesheet.hours'
        db.alter_column(u'volunteer_timesheet', 'hours', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))
    ...
    models = {
        ...
        u'volunteer.timesheet': {
            ...
            'hours': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '3'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
