...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'volunteer_purchase', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Purchase.date'
        db.alter_column(u'volunteer_purchase', 'date', self.gf('django.db.models.fields.DateField')())
