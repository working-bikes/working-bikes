...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PurchaseApproval'
        db.create_table(u'volunteer_purchaseapproval', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('purchase', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['volunteer.Purchase'], unique=True)),
            ('approved_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'volunteer', ['PurchaseApproval'])


    def backwards(self, orm):
        # Deleting model 'PurchaseApproval'
        db.delete_table(u'volunteer_purchaseapproval')
