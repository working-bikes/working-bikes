...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Purchase.date'
        db.add_column(u'volunteer_purchase', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)

        # Adding field 'Event.hours'
        db.add_column(u'volunteer_event', 'hours',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'volunteer_purchase', 'date')

        # Deleting field 'Event.hours'
        db.delete_column(u'volunteer_event', 'hours')
