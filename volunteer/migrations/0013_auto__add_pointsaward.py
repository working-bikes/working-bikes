...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PointsAward'
        db.create_table(u'volunteer_pointsaward', (
        ...
        db.send_create_signal(u'volunteer', ['PointsAward'])


    def backwards(self, orm):
        # Deleting model 'PointsAward'
        db.delete_table(u'volunteer_pointsaward')
