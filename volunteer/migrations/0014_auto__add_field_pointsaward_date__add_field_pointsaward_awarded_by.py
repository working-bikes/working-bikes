...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PointsAward.date'
        db.add_column(u'volunteer_pointsaward', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 2, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PointsAward.awarded_by'
        db.add_column(u'volunteer_pointsaward', 'awarded_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PointsAward.date'
        db.delete_column(u'volunteer_pointsaward', 'date')

        # Deleting field 'PointsAward.awarded_by'
        db.delete_column(u'volunteer_pointsaward', 'awarded_by_id')
    ...
    models = {
        ...
        u'volunteer.pointsaward': {
            'Meta': {'ordering': "['volunteer__user__first_name']", 'object_name': 'PointsAward'},
            'awarded_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'volunteer.purchase': {
            'Meta': {'ordering': "['volunteer__user__first_name']", 'object_name': 'Purchase'},
        ...
        u'volunteer.purchaseapproval': {
            'Meta': {'object_name': 'PurchaseApproval'},
            'approved_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'purchase': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['volunteer.Purchase']", 'unique': 'True'})
        },
        u'volunteer.task': {
        ...
        u'volunteer.volunteer': {
            'Meta': {'ordering': "['user__first_name']", 'object_name': 'Volunteer'},
